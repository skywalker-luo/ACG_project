...
if __name__ == "__main__":
    title = "bunny_icosahedron"
    description = "Bunny_Hits_Icosahedron"

    object_physics_file = ["bunny_200_subdivided_1.obj", "icosahedron_subdivided_2.obj"]
    object_render_file = ["bunny_200_subdivided_3.obj", "icosahedron_subdivided_4.obj"]
    object_scale_factors = [2.0, 1.0]

    is_static_list = [False, True]
    position_list = [np.array([0.0, 1.234, 0.0]), np.array([0.0, 0.0, 0.0])]
    orientation_list = [np.array([1.0, 0.0, 0.0, 0.0]), np.array([1.0, 0.0, 0.0, 0.0])]
    density_list = [800.0, 1000.0]
    restitution_list = [0.8, 0.8]
    friction_list = [0.3, 0.3]
